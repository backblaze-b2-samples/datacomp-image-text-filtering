...
Make DataComp Image-Text Filtering the canonical identity across the shipped web app,
...
The web app and local API now ship under the DataComp Image-Text Filtering identity.
